...
L["Click To Open BtWQuests"] = "Click para ver esta misión en la ventana de BtWQuests.";
...
L["Format Functionality Handled By"] = "Esta funcionalidad la gestiona %s";
...
L["Format Quest Progress"] = "%d/%d Misiones";     --A functionality is provided by [another addon name] (Used in Settings.lua)
...
L["Font"] = "Fuente";
L["Font Desc"] = "Establece la fuente de la interfaz.";
L["Font Tooltip Normal"] = "Fuente actual: ";
L["Font Tooltip Missing"] = "No se encuentra la fuente seleccionada. Se utilizará la fuente por defecto.";
L["Default"] = "Por defecto";
L["Default Font"] = "Fuente por defecto";
...
L["Hide Sparkles"] = "Ocultar brillo de borde";
L["Hide Sparkles Desc"] = "Desactiva el borde y efecto de brilo en los PnJ de misión.\n\nWoW automáticamente añade brillos a los modelos de PnJ de misión cuando se oculta la interfaz.";
...
L["Camera Zoom Multiplier"] = "Multiplizados de Zoon";
L["Camera Zoom Multiplier Desc"] = "Cuando más bajo el valor, más cerca se moverá la cámara al objetivo..\n\nLa distancia es afectata también por el tamaño del objetivo.";
...
L["Press Tab To Select Reward"] = "Pulsa Tab para seleccionar recompensa.";
L["Press Tab To Select Reward Desc"] = "Pulsa [KEY:PC:TAB] para moverse entre las posibles recompensas cuando entregas una misión.";
...
L["Auto Complete Quest"] = "Auto-completar Misión";
L["Auto Complete Quest Desc"] = "Auto-completa la misión y después muestra el diálogo y recompensas en una ventana separada. Si las recompensas contienen un cofre, puedes hacer clic y abrirlo.\n\n- Cubo de Caramelos (Halloween)\n- Semanal de Khaz Algar";
L["Press Key To Open Container"] = "Press Button To Open Container";
L["Press Key To Open Container Desc PC"] = "Press [KEY:PC:SPACE] to open the rewarded container when you are out of combat.";
L["Press Key To Open Container Desc Xbox"] = "Press [KEY:XBOX:PAD3] to open the rewarded container when you are out of combat.";
L["Press Key To Open Container Desc PlayStation"] = "Press [KEY:PS:PAD3] to open the rewarded container when you are out of combat.";
L["Press Key To Open Container Desc Switch"] = "Press [KEY:SWITCH:PAD3] to open the rewarded container when you are out of combat.";
...
L["Show Hint Desc"] = "Añade un botón que selecciona automáticamente la respuesta correcta si es posible.\n\nActualmente sólo soporta el Quiz durante Camino del Tiempo.";
...
L["Disable DUI In Instance"] = "Utilizar la interfaz por defecto de WoW en una Estancia";
L["Disable DUI In Instance Desc"] = "Desactiva la interfaz de Dialogue UI y utilizar la interfaz por defecto cuando estás en una Mazmorra o Banda.\n\nActiva esta opción si no puedes interactuar con un Pnj que te permita comenzar o saltar encuentros de Jefe.";
...
L["TTS Auto Play Delay"] = "Retrasar Lectura";
L["TTS Auto Play Delay Desc"] = "Añade un retraso leve antes de comenzar la lectura automáticamente para que no se sobreponga a la voz del propio PnJ.";
...
L["BookUI Enable"] = "Utilizar la nueva interfaz para Objectos Legibles";
L["BookUI Enable Desc"] = "Utilizar la nueva interfaz para los Objetos Legibles como libros, cartas, y notas.";
L["BookUI Frame Size Desc"] = "Establece el tamaño de la fuente de Book UI.";
L["BookUI Keep UI Open"] = "Mantener Ventana Abierta";
L["BookUI Keep UI Open Desc"] = "Mantener la ventana abierta cuando te alejas del objeto.\n\nPulsa Escape o click derecho en la interfaz para cerrarlo.";
L["BookUI Show Location"] = "Mostrar Ubicación";
L["BookUI Show Location Desc"] = "Muestra la ubicación del objeto en el encabezado.\n\nSolo funciona para objetos de mundo, no objetos en tu bolsa.";
L["BookUI Show Item Description"] = "Mostrar Descripción de Objeto";
L["BookUI Show Item Description Desc"] = "Si el objeto tiene una descripción en la ventana emergente, mostrarlo en la parte superior de la interfaz.";
L["BookUI Darken Screen"] = "Oscurecer pantalla";
L["BookUI Darken Screen Desc"] = "Oscurece el área bajo la interfaz para ayudar a concentrarte en el contenido.";
L["BookUI TTS Voice"] = "Voz";
L["BookUI TTS Voice Desc"] = "Utilizar esta voz para Objetos Legibles:";
L["BookUI TTS Click To Read"] = "Clic en párrafo para Leer";
L["BookUI TTS Click To Read Desc"] = "Clic en párrafo para leerlo.\n\nClic en el párrafo siendo leído para parar la lectura.";
...
--DO NOT TRANSLATE
L["Abbrev Breakpoint 1000"] = FIRST_NUMBER_CAP_NO_SPACE or "M";     --1,000 = 1K
...
L["Pin Auction House"] = BUTTON_LAG_AUCTIONHOUSE or "Casa de Subastas";
L["Pin Bank"] = BANK or "Banco";
L["Pin Barber"] = MINIMAP_TRACKING_BARBER or "Peluquero";
L["Pin Battle Pet Trainer"] = "Instructor de mascotas de duelo";
L["Pin Crafting Orders"] = PROFESSIONS_CRAFTING_ORDERS_TAB_NAME or "Pedidos de fabricación";
L["Pin Flight Master"] = MINIMAP_TRACKING_FLIGHTMASTER or "Maestro de vuelo";
L["Pin Great Vault"] = DELVES_GREAT_VAULT_LABEL or "Gran cámara";
L["Pin Inn"] = "Posada";
L["Pin Item Upgrades"] = "Mejoras de objetos";
L["Pin Mailbox"] = MINIMAP_TRACKING_MAILBOX or "Buzón";
L["Pin Other Continents"] = "Otros continentes";
L["Pin POI"] = MINIMAP_TRACKING_POI or "Puntos de interés";
L["Pin Profession Trainer"] = "Instructor de profesión";
L["Pin Rostrum"] = "Podio de transformación";
L["Pin Stable Master"] = MINIMAP_TRACKING_STABLEMASTER or "Maestro de establos";
L["Pin Trading Post"] = BATTLE_PET_SOURCE_12 or "Puesto comercial";
L["Pin Transmogrifier"] = MINIMAP_TRACKING_TRANSMOGRIFIER or "Tranfigurador";
...
L["Pin Void Storage"] = VOID_STORAGE or "Almacenamiento de Vacío";
